    ...
    , Html.section
      ...
      , Html.p
        ...
        [ Html.text 
            ...
            ++ "types of programming practice found among developers in the Elm. "
            ...
            ++ "that have experience creating Web applications in both Elm and "
            ++ "JavaScript. Potential participants with experience using other "
            ++ "languages such as PureScript or Svelte are welcome too."
        ]
      , Html.p
        [ Html.Attributes.class "mb-2" ]
        [ Html.text
            <| "In this study you'll be asked to complete a questionnaire. It is "
            ++ "expected to take around 15-20 minutes. In it, you'll be asked "
            ...
            ++ "practice. Finally, there will be a series of freeform questions "
            ++ "where you will have the opportunity to talk about Elm, JavaScript, "
            ++ "and any other languages you might have used."
        ]
      , Html.p
        [ Html.Attributes.class "mb-2" ]
        [ Html.text
